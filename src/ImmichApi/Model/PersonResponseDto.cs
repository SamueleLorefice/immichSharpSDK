...
namespace ImmichApi.Model
{
    ...
    /// PersonResponseDto
    /// </summary>
    [DataContract(Name = "PersonResponseDto")]
    public partial class PersonResponseDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonResponseDto" /> class.
        /// </summary>
        ...
        public PersonResponseDto(DateOnly birthDate = default(DateOnly), string id = default(string), bool isHidden = default(bool), string name = default(string), string thumbnailPath = default(string), DateTime updatedAt = default(DateTime))
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PersonResponseDto and cannot be null");
            }
            this.Id = id;
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PersonResponseDto and cannot be null");
            }
            this.Name = name;
            // to ensure "thumbnailPath" is required (not null)
            if (thumbnailPath == null)
            {
                throw new ArgumentNullException("thumbnailPath is a required property for PersonResponseDto and cannot be null");
            }
