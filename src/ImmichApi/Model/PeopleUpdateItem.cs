...
namespace ImmichApi.Model
{
    ...
    /// PeopleUpdateItem
    /// </summary>
    [DataContract(Name = "PeopleUpdateItem")]
    public partial class PeopleUpdateItem : IValidatableObject
    {
        ...
        /// <param name="id">Person id. (required).</param>
        /// <param name="isHidden">Person visibility.</param>
        /// <param name="name">Person name..</param>
        public PeopleUpdateItem(DateOnly birthDate = default(DateOnly), string featureFaceAssetId = default(string), string id = default(string), bool isHidden = default(bool), string name = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PeopleUpdateItem and cannot be null");
            }
            this.Id = id;
