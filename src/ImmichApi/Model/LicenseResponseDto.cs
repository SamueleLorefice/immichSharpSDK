...
namespace ImmichApi.Model
{
    ...
    /// LicenseResponseDto
    /// </summary>
    [DataContract(Name = "LicenseResponseDto")]
    public partial class LicenseResponseDto : IValidatableObject
    {
        ...
        public LicenseResponseDto(DateTime activatedAt = default(DateTime), string activationKey = default(string), string licenseKey = default(string))
        {
            this.ActivatedAt = activatedAt;
            // to ensure "activationKey" is required (not null)
            if (activationKey == null)
            {
                throw new ArgumentNullException("activationKey is a required property for LicenseResponseDto and cannot be null");
            }
            this.ActivationKey = activationKey;
            // to ensure "licenseKey" is required (not null)
            if (licenseKey == null)
            {
                throw new ArgumentNullException("licenseKey is a required property for LicenseResponseDto and cannot be null");
            }
