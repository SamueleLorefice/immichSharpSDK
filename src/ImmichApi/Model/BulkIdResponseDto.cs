...
namespace ImmichApi.Model
{
    ...
    /// BulkIdResponseDto
    /// </summary>
    [DataContract(Name = "BulkIdResponseDto")]
    public partial class BulkIdResponseDto : IValidatableObject
    {
        ...
        public BulkIdResponseDto(ErrorEnum? error = default(ErrorEnum?), string id = default(string), bool success = default(bool))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for BulkIdResponseDto and cannot be null");
            }
            this.Id = id;
