...
namespace ImmichApi.Model
{
    ...
    public partial class UserResponseDto : IValidatableObject
    {
        ...
        public UserResponseDto(UserAvatarColor avatarColor = default(UserAvatarColor), string email = default(string), string id = default(string), string name = default(string), string profileImagePath = default(string))
        {
            ...
            {
                throw new ArgumentNullException("profileImagePath is a required property for UserResponseDto and cannot be null");
            }
