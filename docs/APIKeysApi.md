...
try
{
    ApiResponse<APIKeyCreateResponseDto> response = apiInstance.CreateApiKeyWithHttpInfo(aPIKeyCreateDto);
...
namespace Example
{
    public class GetApiKeyExample
    {
        public static void Main()
        {
            ...
            try
            {
                APIKeyResponseDto result = apiInstance.GetApiKey(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
try
{
    ApiResponse<APIKeyResponseDto> response = apiInstance.GetApiKeyWithHttpInfo(id);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class GetApiKeysExample
    {
        public static void Main()
        {
            ...
            try
            {
                List<APIKeyResponseDto> result = apiInstance.GetApiKeys();
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
try
{
    ApiResponse<List<APIKeyResponseDto>> response = apiInstance.GetApiKeysWithHttpInfo();
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class UpdateApiKeyExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new APIKeysApi(config);
            var id = "id_example";  // Guid | 
            var aPIKeyUpdateDto = new APIKeyUpdateDto(); // APIKeyUpdateDto | 

            try
            {
                APIKeyResponseDto result = apiInstance.UpdateApiKey(id, aPIKeyUpdateDto);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
try
{
    ApiResponse<APIKeyResponseDto> response = apiInstance.UpdateApiKeyWithHttpInfo(id, aPIKeyUpdateDto);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
