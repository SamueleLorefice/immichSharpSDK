# ImmichApi.Api.AuthenticationApi
...
namespace Example
{
    public class ChangePasswordExample
    {
        public static void Main()
        {
            ...
            try
            {
                UserAdminResponseDto result = apiInstance.ChangePassword(changePasswordDto);
...
try
{
    ApiResponse<UserAdminResponseDto> response = apiInstance.ChangePasswordWithHttpInfo(changePasswordDto);
...
namespace Example
{
    public class LoginExample
    {
        public static void Main()
        {
            ...
            config.BasePath = "/api";
            var apiInstance = new AuthenticationApi(config);
            var loginCredentialDto = new LoginCredentialDto(); // LoginCredentialDto | 

            try
            {
                LoginResponseDto result = apiInstance.Login(loginCredentialDto);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
try
{
    ApiResponse<LoginResponseDto> response = apiInstance.LoginWithHttpInfo(loginCredentialDto);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class LogoutExample
    {
        public static void Main()
        {
            ...
            try
            {
                LogoutResponseDto result = apiInstance.Logout();
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
try
{
    ApiResponse<LogoutResponseDto> response = apiInstance.LogoutWithHttpInfo();
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
namespace Example
{
    public class SignUpAdminExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            try
            {
                UserAdminResponseDto result = apiInstance.SignUpAdmin(signUpDto);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling AuthenticationApi.SignUpAdmin: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the SignUpAdminWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<UserAdminResponseDto> response = apiInstance.SignUpAdminWithHttpInfo(signUpDto);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling AuthenticationApi.SignUpAdminWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class ValidateAccessTokenExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            try
            {
                ValidateAccessTokenResponseDto result = apiInstance.ValidateAccessToken();
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling AuthenticationApi.ValidateAccessToken: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the ValidateAccessTokenWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    ApiResponse<ValidateAccessTokenResponseDto> response = apiInstance.ValidateAccessTokenWithHttpInfo();
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling AuthenticationApi.ValidateAccessTokenWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
