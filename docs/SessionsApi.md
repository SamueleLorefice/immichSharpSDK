...
namespace Example
{
    public class DeleteAllSessionsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling SessionsApi.DeleteAllSessions: " + e.Message);
...
#### Using the DeleteAllSessionsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.

```csharp
try
{
    apiInstance.DeleteAllSessionsWithHttpInfo();
}
catch (ApiException e)
{
    Debug.Print("Exception when calling SessionsApi.DeleteAllSessionsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
try
{
    apiInstance.DeleteSessionWithHttpInfo(id);
}
catch (ApiException e)
{
...
namespace Example
{
    public class GetSessionsExample
    {
        public static void Main()
        {
            ...
            try
            {
                List<SessionResponseDto> result = apiInstance.GetSessions();
...
try
{
    ApiResponse<List<SessionResponseDto>> response = apiInstance.GetSessionsWithHttpInfo();
